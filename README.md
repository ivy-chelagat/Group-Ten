...
- Combines SVD and CBF:
  ...
  Final Score = 𝛼 × SVD Score + (1 − 𝛼) × Genre Score
...
Scatter P<img width="833" height="468" alt="download" src="https://github.com/user-attachments/assets/f1bff6d4-4ea1-47d3-a613-cc5d6c39f604" />
lot: Showed predicted vs. actual ratings — Hybrid predictions clustered more tightly for highly rated movies.
